...
$slug = 'constituency-tree';
$council_name = 'Browse data by constituency';  // used in the title and breadcrumb
...
head("#ge2017 Browse data by constituency - interface to crowd-sourced data for the UK General Election2017", 0,0,0, "/website/image/treeview1.png");
